function moduleProject3() {
  ...
  function buildLearnerCard(learner, languages) {
    ...
    [nameP, IdP, dobP, favLangP].forEach(p => {
      card.appendChild(p)
    })
  ...
  function buildFooter(footerData) {
    ...
    let compInfoDiv = document.createElement('p')
    compInfoDiv.classList.add('company-info')

    let compNameP = document.createElement('p')
    compNameP.classList.add('company-name')
    compNameP.textContent = footerData.companyName
    ...
    compInfoDiv.appendChild(compNameP)
    compInfoDiv.appendChild(addressP)
    compInfoDiv.appendChild(contactEmailP)
    ...
    compInfoDiv.appendChild(socialMediaDiv)
    compInfoDiv.appendChild(copyright)
    footer.appendChild(compInfoDiv)
